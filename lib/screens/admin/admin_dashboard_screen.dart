...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Future<void> _setPaymentTestMode(bool testMode) async {
    ...
    _message(testMode
        ...
        : 'Live mode on: customers pay through a free PayMongo QR Ph code.');
  }
          ...
          children: [
            ListView(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                const Text(
                    'Customers pay with QR Ph — the free PayMongo payment method. '
                    'SkyeLoop asks PayMongo for a QR on the spot and only starts the '
                    'session after PayMongo confirms the payment. It works with any '
                    'bank or e-wallet app (GCash, Maya, and more). No QR images need '
                    'to be uploaded.'),
                const SizedBox(height: 14),
                Card(
                  child: Padding(
                              ...
                              Expanded(
                                child: Text(
                                  config.paymentTestMode
                                      ...
                                      : 'LIVE — customers scan a free QR Ph code '
                                          'generated by PayMongo with any bank or '
                                          'e-wallet app, and the session starts only '
